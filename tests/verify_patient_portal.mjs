...
assert.match(app, /Buenos dias|Buenos d.as/, 'debe saludar al paciente en lenguaje natural');
...
assert.match(app, /Impacto estimado/, 'debe explicar impacto temporal de mover citas');
