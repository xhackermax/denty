...
if (!sharedUiTest.includes("container.textContent")) {
  fail("el test monetario debe comparar formatEUR sin normalizar espacios Unicode");
}
if (!densityProvider.includes("useSyncExternalStore")) {
  fail("la densidad debe modelarse como store externo, no hidratarse con setState en effect");
}
