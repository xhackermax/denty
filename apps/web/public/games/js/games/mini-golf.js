(function (global) {
  ...
  function createGame(){
    ...
    function draw(){if(!ctx)return;const c=course();ctx.clearRect(0,0,W,H);ctx.fillStyle='#e8f4ed';ctx.fillRect(0,0,W,H);ctx.strokeStyle='#9bc7ad';ctx.lineWidth=3;ctx.strokeRect(24,24,W-48,H-48);for(const wall of c.walls){ctx.fillStyle='#d7e1e9';global.DentyGames.shared.roundedRect(ctx,wall.x,wall.y,wall.w,wall.h,8);ctx.fill();}
