...
export function createAnalyticsResource(client: ApiClient) {
  return {
    ...
    comparison: (query: z.input<typeof analyticsQuerySchema> = {}) =>
      client.request(
        analyticsPath("/api/analytics/comparison", query),
        analyticsResultSchema,
      ),
    ...
    treatments: (query: z.input<typeof analyticsQuerySchema> = {}) =>
      client.request(
        analyticsPath("/api/analytics/treatments", query),
        analyticsItemsSchema,
      ),
    ...
    purchases: (query: z.input<typeof analyticsQuerySchema> = {}) =>
      client.request(
        analyticsPath("/api/analytics/purchases", query),
        analyticsResultSchema,
      ),
    ...
    costRecipes: {
      ...
      retire: (
        id: string,
        payload: z.input<typeof retireTreatmentCostRecipeSchema> = {},
      ) =>
        client.mutation(
