...
export function ClinicalSyncCard({ patientId, demoMode }: ClinicalSyncCardProps) {
    ...
    return (
      <section className={styles.section}>
        <Group justify="space-between" align="flex-start">
          <div>
            <Title order={3}>Sincronización clínica</Title>
  ...
  if (syncQuery.isError) {
    return (
      <Alert color="red" title="No se pudo comprobar la sincronización clínica">
  ...
  return (
    <section className={styles.section}>
      ...
      <SimpleGrid cols={{ base: 1, sm: 3 }} mt="lg">
        <div>
          <Text c="dimmed" size="xs">Odontograma</Text>
        ...
        <div>
          <Text c="dimmed" size="xs">Plan</Text>
        ...
        <div>
          <Text c="dimmed" size="xs">Presupuesto</Text>
      ...
      {planSync.isError || budgetSync.isError ? (
        <Alert mt="lg" color="red" title="No se pudo sincronizar">
