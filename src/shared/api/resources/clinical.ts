  ...
  return {
    plan: {
      get: (patientId: string) =>
        client.request(
          `/api/patients/${encodeId(patientId)}/clinical-plan`,
          clinicalPlanSchema,
        ),
      ...
      overridePriority: (
        itemId: string,
        payload: z.input<typeof priorityOverrideSchema>,
      ) =>
        client.mutation(
      ...
      createAlternatives: (
        patientId: string,
        payload: z.input<typeof alternativeSetInputSchema>,
      ) =>
        client.mutation(
      ...
      recordPreference: (
        patientId: string,
        payload: z.input<typeof recordPreferenceSchema>,
      ) =>
        client.mutation(
      ...
      addDependency: (
        planId: string,
        payload: z.input<typeof planDependencySchema>,
      ) =>
        client.mutation(
    ...
    odontogram: {
      get: (patientId: string) =>
        client.request(
          `/api/patients/${encodeId(patientId)}/odontogram`,
          odontogramSchema,
        ),
      ...
      periodontal: (
        patientId: string,
        measurement: z.input<typeof periodontalMeasurementSchema>,
      ) =>
        client.mutation(
      ...
      snapshots: {
        ...
        create: (
          patientId: string,
          payload: z.input<typeof createOdontogramSnapshotSchema>,
        ) =>
          client.mutation(
            `/api/patients/${encodeId(patientId)}/odontogram/snapshots`,
            odontogramSnapshotSchema,
    ...
    workflow: {
      ...
      createProblem: (
        patientId: string,
        payload: z.input<typeof clinicalProblemInputSchema>,
      ) =>
        client.mutation(
      ...
      createEncounter: (
        patientId: string,
        payload: z.input<typeof clinicalEncounterInputSchema>,
      ) =>
        client.mutation(
